    ...
    <div>
        ...
        <Drawer :mask-closable="false" :title="formData.id ? '修改':'添加'" width="50%" v-model="isedit">
            <Form :model="formData" :label-width="80">
                ...
                <FormItem label="支出金额">
                    <Input v-model="formData.amount" prefix="logo-yen" placeholder="支出金额" @keyup.enter.native="toSubmit"/>
                </FormItem>
    ...
    data() {
        return {
            ...
            columns: [
                ...
                { title: "支出用途", key: "useFor" },
                { title: "支出金额", key: "amount" },
    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(
                        this.api.admin.base + this.api.admin.charity_list_info,
                        {
                            id: e
                        }
                    )
            ...
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .post(
                            this.api.admin.base +
                                this.api.admin.charity_list_del,
                            {
        ...
        toSubmit() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.charity_list_edit,
                    data
                )
                .then(res => {
                    if (res.code === 200) {
        ...
        toDrft() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.charity_list_drft,
                    data
                )
                .then(res => {
                    if (res.code === 200) {

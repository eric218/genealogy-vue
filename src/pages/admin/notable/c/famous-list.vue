    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(
                        this.api.admin.base + this.api.admin.admin_famous_info,
                        {
                            id: e
                        }
                    )
            ...
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .get(
                            this.api.admin.base +
                                this.api.admin.admin_famous_del,
                            {
        ...
        toSubmit() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.admin_famous_edit,
                    data
                )
                .then(res => {
                    if (res.code === 200) {
        ...
        toDrft() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.admin_famous_drft,
                    data
                )
                .then(res => {
                    if (res.code === 200) {

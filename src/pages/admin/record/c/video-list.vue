            ...
            <div class="cover">
              <div>
                ...
                <Icon
                  ...
                  @click.native="handleView(v.fanUploadVedioList[0].filePath)"
                ></Icon>
        ...
        <FormItem label="预览图">
          ...
          >
            <Button type="dashed">
              ...
              <div
                class="img"
                :style="formData.fanNewsUploadFile.length ? api.imgBG(formData.fanNewsUploadFile[0].filePath) : ''"
                v-else-if="formData.fanNewsUploadFile.length"
              ></div>
  ...
  methods: {
    ...
    handleRemove(e) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.api
            .get(this.api.admin.base + this.api.admin.media_del, {
              id: e.id
            })
            .then(res => {
              this.getList();
    ...
    toSubmit() {
      ...
      this.api
        .post(this.api.admin.base + this.api.admin.media_edit, data)
        .then(res => {
          if (res.code === 200) {
            if (data.id) {

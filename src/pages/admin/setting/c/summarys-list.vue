...
export default {
    data() {
        return {
            ...
            columns: [
                { title: "ID", key: "id" },
                { title: "堂", key: "title" },
                { title: "始迁祖", key: "rootPerson" },
                { title: "负责人", key: "leader" },
                { title: "负责人电话", key: "leaderPhone" },
                {
                    title: "操作",
                    key: "action",
                    width: 150,
    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(
                        this.api.admin.base +
                            this.api.admin.admin_summarys_info,
                        {
                            id: e
                        }
                    )
            ...
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .get(
                            this.api.admin.base +
                                this.api.admin.admin_summarys_del,
                            {
        ...
        toSubmit() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.admin_summarys_edit,
                    data
                )
                .then(res => {
                    if (res.code === 200) {
        ...
        toDrft() {
            ...
            this.api
                .post(
                    this.api.admin.base + this.api.admin.admin_summarys_drft,
                    data
                )
                .then(res => {
                    if (res.code === 200) {

        ...
        <div class="inner">
            ...
            <div class="right-card card">
                <div class="info">
                    ...
                    <div class="f" v-if="index_architecture_pay_in_person_1">
                        <div class="item" v-for="(v,i) in index_architecture_pay_in_person_1.records" :key="i" :style="api.imgBG(v.allUserLogin.picSrc)"></div>
...
export default {
    ...
    methods: {
            ...
            this.api
                .get(
                    this.api.county.base +
                        this.apiList.index_fan_summary.apiUrl,
                    {}
                )
                .then(res => {
                    if (res.code == 200) {
        ...
        get_index_fund() {
            this.api
                .get(
                    this.api.county.base + this.apiList.index_fund_1.apiUrl,
                    {}
                )
                .then(res => {
                    if (res.code == 200) {
        ...
        get_index_architecture_pay_in_person_1() {
            this.api
                .get(
                    this.api.county.base +
                        this.apiList.index_architecture_pay_in_person_1.apiUrl,
                    {}
                )
                .then(res => {
                    if (res.code == 200) {

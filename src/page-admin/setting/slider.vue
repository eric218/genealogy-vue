<template>
    <div>
        ...
        <Upload ref="upload" class="upload" :action="api.admin + api.urls.upload_img" name="file" :show-upload-list="false" :on-success="handleSuccess" :format="['jpg','jpeg','png']" :max-size="2048" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :default-file-list="list">
...
export default {
    ...
    methods: {
        getList() {
            this.api.get(this.api.admin + this.api.urls.admin_slider_list, {
        ...
        handleSuccess(res, file) {
            ...
            this.api.post(this.api.admin + this.api.urls.admin_slider_edit, data).then(res => {
                this.getList();
            })
        },
